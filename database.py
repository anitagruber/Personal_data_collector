...
def insert_personal(first_name,middle_name,last_name,date_of_birth,
    ...
    cursor.execute('INSERT INTO personal (first_name,middle_name,last_name,date_of_birth,gender,phone_number,email) VALUES '
    '(%s,%s,%s,%s,%s,%s,%s) returning id;',[first_name,middle_name,last_name,date_of_birth,gender,phone_number,email])
...
def insert_address(personal_id,address_line_1,address_line_2,city,state,zip_code,country):
    connection = get_connection()
    cursor = connection.cursor()
    cursor.execute('INSERT INTO address (personal_id,address_line_1,address_line_2,city,state,zip_code,country) VALUES '
    '(%s,%s,%s,%s,%s,%s,%s);',[personal_id,address_line_1,address_line_2,city,state,zip_code,country])
    connection.commit()
    cursor.close()
    connection.close()
...
def insert_education(personal_id,highest_level_of_education,institution,year_of_graduation):
    connection = get_connection()
    cursor = connection.cursor()
    cursor.execute('INSERT INTO education (personal_id,highest_level_of_education,institution,year_of_graduation) VALUES '
    '(%s,%s,%s,%s);',[personal_id,highest_level_of_education,institution,year_of_graduation])
    connection.commit()
    cursor.close()
    connection.close()
...
def insert_employment(personal_id,current_employment_status,current_job_title,company):
    connection = get_connection()
    cursor = connection.cursor()
    cursor.execute('INSERT INTO employment (personal_id,current_employment_status,current_job_title,company) VALUES '
    '(%s,%s,%s,%s);',[personal_id,current_employment_status,current_job_title,company])
    connection.commit()
    cursor.close()
    connection.close()
